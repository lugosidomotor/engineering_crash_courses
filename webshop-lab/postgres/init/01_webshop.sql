...
INSERT INTO course.materials (course_slug, course_title, primary_services, artifact, how_to_use) VALUES
  ...
  ('local-llm-engineering', 'Local LLM Engineering', ARRAY['api', 'chroma', 'streamlit', 'mlflow', 'prometheus', 'grafana', 'lab-runner'], 'local LLM gateway, RAG és benchmark minta', 'A WebShop Pro support bothoz privacy-first lokális LLM gateway, retrieval és hybrid routing terv készül.'),
